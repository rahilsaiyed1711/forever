...
const Orders = () => {
  ...
  return (
    <div className='pt-16 border-t'>
      ...
      { 
        orders.map((idx, order)=>{
          const productData = products.find((product)=>{
            product._id === order._id;
          })
          return ( 
            <div key={idx} className='py-4 border-t border-b text-gray-700 flex flex-col md:flex-row md:items-center md:justify-between g4'> 
                <div className='flex item-start gap-6'>
                   <img src={productData.img[0]} className='w-16 sm:w-20' alt="" />
                   <div>
